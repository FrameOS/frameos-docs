...
The backend is a Python webapp, run through docker. It can be installed as a [Home Assistant Addon](https://github.com/FrameOS/frameos-home-assistant-addon) 
...
- Join the [FrameOS discord](https://discord.gg/pb2EHnfn)
