...
- Someplace to run the FrameOS backend. Either run it [via docker locally](https://frameos.net/guide/backend#running-via-docker), or host it in a server. It'll connect to the frames via SSH.
