...
### An operating system for <span style={{textDecoration:'underline'}}>single function smart frames</span>. 
...
We support the most common e-ink displays out there (most [Waveshare](https://www.waveshare.com/product/displays/e-paper/epaper-1.htm) and 
