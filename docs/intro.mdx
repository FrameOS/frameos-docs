...
- Someplace to run the FrameOS backend. Either run it [locally via docker](https://frameos.net/guide/backend#running-via-docker), or host on in a server. It'll connect to the frames using SSH.
