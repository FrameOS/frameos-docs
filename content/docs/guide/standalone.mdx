...
`frame1234`). Join it from your phone or laptop and open `http://10.42.0.1/`. The setup page asks
for:
...
Save, and the Pi joins your network. On HDMI you watch it happen: the FrameOS status screen draws
...
time zone, how it is managed (*standalone*), and the frame's URL.
