...
- **Some panels are the problem.** A 13.3" 1600×1200 six-colour canvas is 7.7&nbsp;MB on its own,
  before any image exists. That's why that board carries 16&nbsp;MB of PSRAM.
