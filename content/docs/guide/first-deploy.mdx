...
backend to deploy a scene." Once it has scenes, that same screen lists them, and it notes the last
GPIO button pressed - handy when a panel looks blank and you want to know whether the frame is
fine, or whether a button is wired right.
