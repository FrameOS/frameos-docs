...
Click "New frame" in the backend. Give the frame a name, enter its IP address or hostname and SSH
credentials, and select the right **display driver** for your panel - there are over 120 to choose
from, organised by vendor. Pick "Web only" if you just want to try FrameOS without any display
hardware.
