---
title: "Waveshare 2.13\" (B V3) e-Paper"
description: "212×104 black/white/red e-ink display for FrameOS - specs, setup and driver details."
device:
  vendor: "Waveshare"
  model: "2.13\" (B V3) e-Paper"
  driver: "waveshare.EPD_2in13b_V3"
