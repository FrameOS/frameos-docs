---
title: "Waveshare 2.9\" (BC) e-Paper"
description: "296×128 black/white/yellow e-ink display for FrameOS - specs, setup and driver details."
device:
  vendor: "Waveshare"
  model: "2.9\" (BC) e-Paper"
  driver: "waveshare.EPD_2in9bc"
  ...
  colorCount: 3
  colorClass: "accent"
  productUrl: "https://www.waveshare.com/2.9inch-e-Paper-C.htm?&aff_id=79380"
  image: "/images/devices/waveshare-2-9inch-e-paper-c-1.jpg"
  links:
    - label: "Waveshare wiki"
      url: "https://www.waveshare.com/wiki/2.9inch_e-Paper_Module_(C)"
  status: "untested"
---
