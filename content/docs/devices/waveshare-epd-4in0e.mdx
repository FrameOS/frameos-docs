...
device:
  ...
  image: "/images/devices/waveshare-epd-4in0e.jpg"
  links:
    - label: "Waveshare wiki"
      url: "https://www.waveshare.com/wiki/4inch_e-Paper_HAT%2B_(E)"
  cases:
    - label: "Desk case preset"
      url: "https://cases.frameos.net/#path=waveshare.4in0e.desk.scad"
      image: "/images/cases/waveshare-4in0e-desk-case.png"
  status: "tested"
---
