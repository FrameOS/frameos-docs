---
title: "Waveshare 5.83\" (V2) e-Paper"
description: "648×480 4-level grayscale e-ink display for FrameOS - specs, setup and driver details."
device:
  vendor: "Waveshare"
  model: "5.83\" (V2) e-Paper"
  driver: "waveshare.EPD_5in83_V2"
