---
title: "Waveshare 10.2\" (B) e-Paper"
description: "960×640 black/white/red e-ink display for FrameOS - specs, setup and driver details."
device:
  vendor: "Waveshare"
  model: "10.2\" (B) e-Paper"
  driver: "waveshare.EPD_10in2b"
