---
title: "Waveshare 5.83\" (BC) e-Paper"
description: "600×448 black/white/yellow e-ink display for FrameOS - specs, setup and driver details."
device:
  vendor: "Waveshare"
  model: "5.83\" (BC) e-Paper"
  driver: "waveshare.EPD_5in83bc"
