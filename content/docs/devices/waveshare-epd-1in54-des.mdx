---
title: "Waveshare 1.54\" (DES) e-Paper"
description: "152×152 black & white e-ink display for FrameOS - specs, setup and driver details."
device:
  vendor: "Waveshare"
  model: "1.54\" (DES) e-Paper"
  driver: "waveshare.EPD_1in54_DES"
