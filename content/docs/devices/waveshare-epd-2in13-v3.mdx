---
title: "Waveshare 2.13\" (V3) e-Paper"
description: "250×122 black & white e-ink display for FrameOS - specs, setup and driver details."
device:
  vendor: "Waveshare"
  model: "2.13\" (V3) e-Paper"
  driver: "waveshare.EPD_2in13_V3"
