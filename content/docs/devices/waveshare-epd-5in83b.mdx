---
title: "Waveshare 5.83\" (B) e-Paper"
description: "600×448 black/white/red e-ink display for FrameOS - specs, setup and driver details."
device:
  vendor: "Waveshare"
  model: "5.83\" (B) e-Paper"
  driver: "waveshare.EPD_5in83b"
