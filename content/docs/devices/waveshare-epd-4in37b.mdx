---
title: "Waveshare 4.37\" (B) e-Paper"
description: "480×176 black/white/red e-ink display for FrameOS - specs, setup and driver details."
device:
  vendor: "Waveshare"
  model: "4.37\" (B) e-Paper"
  driver: "waveshare.EPD_4in37b"
