...
keep them private or make them public, and anyone can install them on a cloud-managed frame with
one click or on a self-hosted backend by pasting a link. Scenes also export as JSON (and as ZIP
